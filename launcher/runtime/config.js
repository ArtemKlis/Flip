// ====== LAUNCHER CONFIG ====== //
var config = {
    dir: ".flipmc", // Launcher directory
    title: "FlipMC | Launcher", // Window title
    icons: [ "favicon.png" ], // Window icon paths

    // Auth config
    newsURL: "http://flipmc.great-site.net/", // News WebView URL
    linkText: "Регистрация", // Text for link under "Auth" button
    linkURL: new java.net.URL("http://flipmc.great-site.net/?mode=register"), // URL for link under "Auth" button
